    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-gray-400">Welcome back! Here's what's happening with your app.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="bg-[#0F1E35] border-cyan-500/20">
            ...
            <CardContent className="space-y-2">
              <a href="/admin/popups" className="block p-3 rounded-lg bg-cyan-500/10 hover:bg-cyan-500/20 transition-colors border border-cyan-500/20">
                <p className="text-white font-medium">Create Pop-up</p>
                <p className="text-sm text-gray-400">Add new announcement</p>
              </a>
              <a href="/admin/maintenance" className="block p-3 rounded-lg bg-purple-500/10 hover:bg-purple-500/20 transition-colors border border-purple-500/20">
                <p className="text-white font-medium">Toggle Maintenance</p>
                <p className="text-sm text-gray-400">Enable/disable maintenance mode</p>
              </a>
            </CardContent>
          </Card>
        </div>
